// src/layouts/LayoutPrincipal.jsx — versão corrigida e atualizada
...
export default function LayoutPrincipal() {
  ...
  return (
    <div className="min-h-screen flex flex-col text-white relative bg-[#010b0a] overflow-x-hidden">
      {/* HEADER — logomarca sobre o Template Verde */}
      <header
        className="relative w-full z-40 flex flex-col items-center justify-center py-10"
        style={{
      ...
      {/* NAVBAR — agora fixa logo abaixo do header */}
      <nav
        className="w-full z-30 bg-black/30 backdrop-blur-sm border-t border-[#D4AF37]/20"
        style={{
      ...
      {/* CONTEÚDO PRINCIPAL — onde o React Router insere as páginas */}
      <main
        className="flex-grow relative z-10"
        style={{
          marginTop: isHome ? "0px" : "60px",
          paddingBottom: "120px",
        }}
      >
        <Outlet />
